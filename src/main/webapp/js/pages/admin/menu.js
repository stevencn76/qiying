var menuAdmissionData=[
	...
	{id:14,text:"报名时间段设置",iconCls:"icon-statistic",state:"opened",attributes:{type:"menuitem",title:"报名时间段设置",url:"timespace.jsp"}},
	{id:15,text:"新闻管理",iconCls:"icon-statistic",state:"opened",attributes:{type:"menuitem",title:"新闻管理",url:"newslist.jsp"}}
];
var menuSystemData=[
